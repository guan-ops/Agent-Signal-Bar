...
<p align="center">
  <img src="docs/assets/light-effects-zh-CN-hd.gif" alt="Agent Signal Bar 由同一套灯效动画引擎生成的动态灯效预览图" width="720">
</p>

这是动态效果预览图，由 App 实际使用的同一套灯效动画引擎生成，并同时展示经典灯牌和极简圆点两种状态栏样式。
